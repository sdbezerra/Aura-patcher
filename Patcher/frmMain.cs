...
namespace Patcher
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            picTitleLogo.Image = Bitmap.FromFile(Path.Combine(patcherDirectory, "title_logo.png"));
        ...
        {
            string fullPath = Path.Combine(Program.targetDirectory, configuration.GameExe);
            ProcessStartInfo psi = new ProcessStartInfo();
            
            psi.FileName = configuration.GameExe;
            psi.WorkingDirectory = Path.GetDirectoryName(fullPath);
            psi.Arguments = "code:" + configuration.CodeGame + " ver:" + configuration.VerGame + " logip:" + configuration.LogIP + " logport:" + configuration.LogPort + " chatip:" + configuration.ChatIP + " chatport:" + configuration.ChatPort + " setting:" + configuration.GSetting;
